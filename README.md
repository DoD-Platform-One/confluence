...
![Version: 2.0.2-bb.1](https://img.shields.io/badge/Version-2.0.2--bb.1-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square) ![AppVersion: 9.4.1](https://img.shields.io/badge/AppVersion-9.4.1-informational?style=flat-square)
...
| oci://registry1.dso.mil/bigbang | gluon | 0.6.2 |
...
| image.tag | string | `"9.2.5"` | The docker image tag to be used - defaults to the Chart appVersion  |
