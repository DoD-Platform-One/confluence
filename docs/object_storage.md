...
1. Create a plaintext file named `credentials` that contains your AWS access key and secret access key in the following format:
...
1. Create a secret from your credential file:
...
1. To validate you have object storage enabled, once Confluence is setup:
...
1. Login to MinIO using the console at https://minio.bigbang.dev

1. Create a bucket, take note of the name, and check "Versioning".
...
1. Deploy Confluence with the following values:
